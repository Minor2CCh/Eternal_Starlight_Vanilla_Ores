...
public class StarlightGenerateOres {
    ...
    public static final RegistryKey<PlacedFeature> STARLIGHT_COPPER_ORE_PLACED_KEY_LITE = register("lite/starlight_ore_copper");
    public static final RegistryKey<PlacedFeature> STARLIGHT_GOLD_ORE_PLACED_KEY_LITE = register("lite/starlight_ore_gold");
    ...
    public static final RegistryKey<PlacedFeature> STARLIGHT_GOLD_ORE_EXTRA_PLACED_KEY_LITE = register("lite/starlight_ore_gold_extra");
    ...
    public static void initialize() {
        ...
        //reduce version
            ...
            BiomeModifications.addFeature(BiomeSelectors.tag(StarLightBiomeTag.IN_ETERNAL_STARLIGHT), GenerationStep.Feature.UNDERGROUND_ORES, STARLIGHT_IRON_ORE_PLACED_KEY_LITE);
            BiomeModifications.addFeature(BiomeSelectors.tag(StarLightBiomeTag.IN_ETERNAL_STARLIGHT), GenerationStep.Feature.UNDERGROUND_ORES, STARLIGHT_COAL_ORE_PLACED_KEY_LITE);
            BiomeModifications.addFeature(BiomeSelectors.tag(StarLightBiomeTag.IN_ETERNAL_STARLIGHT), GenerationStep.Feature.UNDERGROUND_ORES, STARLIGHT_COPPER_ORE_PLACED_KEY_LITE);
            BiomeModifications.addFeature(BiomeSelectors.tag(StarLightBiomeTag.IN_ETERNAL_STARLIGHT), GenerationStep.Feature.UNDERGROUND_ORES, STARLIGHT_GOLD_ORE_PLACED_KEY_LITE);
            ...
            if(StarlightConfig.getBoolean("ExtraOrePerBiome", true)) {
                ...
                BiomeModifications.addFeature(BiomeSelectors.tag(StarLightBiomeTag.EXTRA_GOLD_ORE), GenerationStep.Feature.UNDERGROUND_ORES, STARLIGHT_GOLD_ORE_EXTRA_PLACED_KEY_LITE);
